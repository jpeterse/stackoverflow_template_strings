...
const char G_MQTT_SELECT_CONFIG[] = R"=====({"entity_category":"config","name":"Timezone","unique_id":"@@unique_name@@_tz","state_topic":"stat/clocks/@@unique_name@@/tz","command_topic":"cmnd/clocks/@@unique_name@@","command_template":"{"tz": {{ this.attributes.options.index(value) }} }","options":[@@timezones@@],"device":{"name":"@@unique_name@@","identifiers":"@@unique_name@@","manufacturer":"Watt-This","model":"Wall Clock v@@hardware_version@@","sw_version":"@@firmware_version@@","configuration_url":"@@ip_address@@"}})=====";
...
const uint8_t G_DISCOVERY_MESSAGE_COUNT = 7;
const DISCOVERY_MESSAGE_T G_DISCOVERY_MESSAGES[ G_DISCOVERY_MESSAGE_COUNT ] = { 
  { G_MQTT_SENSOR_CONFIG_TOPIC, G_MQTT_SENSOR_CONFIG },
  { G_MQTT_SENSOR_AVG_CONFIG_TOPIC, G_MQTT_SENSOR_AVG_CONFIG },
  { G_MQTT_SELECT_CONFIG_TOPIC, G_MQTT_SELECT_CONFIG },
  { G_MQTT_NUMBER_DMD_CONFIG_TOPIC, G_MQTT_NUMBER_DMD_CONFIG },
  { G_MQTT_NUMBER_LED_CONFIG_TOPIC, G_MQTT_NUMBER_LED_CONFIG },
  { G_MQTT_NUMBER_LXN_CONFIG_TOPIC, G_MQTT_NUMBER_LXN_CONFIG },
  { G_MQTT_NUMBER_LXD_CONFIG_TOPIC, G_MQTT_NUMBER_LXD_CONFIG }
};